package br.com.clienteservice.application.config
...
@Component
class JWTUtil(private val clienteService: ClienteService){
    ...
    fun getAuthentication(jwt: String?): Authentication {
        ...
        val cliente = clienteService.loadUserByUsername(username)
        return UsernamePasswordAuthenticationToken(username, cliente.password, cliente.authorities)
    }
}